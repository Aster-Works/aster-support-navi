...
- エアコン助成（air-conditioner-energy）を政令市20市へ展開: 0 published（熊本市はfound/okだが officialUrl が社協ドメインで非許可ホストのため review 据え置き）、17 not_found、2 needs_review（名古屋市・福岡市）。**東京23区は23/23全区に制度があったが、政令市には市全体のエアコン助成があまり普及していない**という正直な調査結果。migration 20260624240000。
